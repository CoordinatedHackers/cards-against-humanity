...
~~~sh
# getting the code
git clone git@github.com:nko4/coordinated-hackers.git && cd ./coordinated-hackers/

# developing
npm install
npm start

# deploying (to http://coordinated-hackers.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@coordinated-hackers.2013.nodeknockout.com
ssh root@coordinated-hackers.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@coordinated-hackers.2013.nodeknockout.com
ssh -i ./id_deploy root@coordinated-hackers.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/coordinated-hackers" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
